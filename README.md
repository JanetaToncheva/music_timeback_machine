Python code which scrapes the Billboard 100 for a specific date added by the user and gets the titles of the topp 100 songs that were popular at that given date back in time.
